...
- 8 hand-made overlays instead of `Modal` (bestiary ×3, characters, chat, dice, maps ×2); `@rolvium/ui` adoption is
  56/84 UI files. `chat/ui/ChatRollPopover.tsx` is the same non-modal, module-specific pattern as `dice/ui/DiceRoller.tsx`
