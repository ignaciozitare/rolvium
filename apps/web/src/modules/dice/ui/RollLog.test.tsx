...
describe('<RollLog>', () => {
  ...
  it('appends live inserts at the top (deduplicated) and shows the empty / error states', async () => {
    ...
    expect(screen.getAllByRole('listitem')[0]).toHaveAttribute('data-roll-id', 'roll-setback');
