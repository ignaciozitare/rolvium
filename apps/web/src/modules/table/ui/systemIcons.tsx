  ...
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" aria-hidden="true" style={{ display: 'block', flexShrink: 0 }}>
      <defs>
        ...
        <filter id={f} x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dx="0" dy="1" stdDeviation="1.2" floodColor="var(--sys-ink)" floodOpacity="0.35" /></filter>
      </defs>
      <path filter={`url(#${f})`} fill={`url(#${g})`} d="M31 4.51 A19 19 0 1 0 31 35.49 A16 16 0 0 1 31 4.51 Z" />
    </svg>
  );
}
