...
export { compressImage, fitDimensions, formatBytes, CompressError, IMAGE_TARGETS, LEVELED_TARGETS, DEFAULT_COMPRESSION_LEVEL, ACCEPTED_MIME, MAX_INPUT_BYTES, MAX_OUTPUT_BYTES, ALPHA_SIDE, alphaOfUrl } from './lib/compressImage';
